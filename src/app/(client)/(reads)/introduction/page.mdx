import { introductionMd } from "@/lib/metadata/metadata"
...
With FMAOS, you can easily create captivating animations that respond to user interactions and scroll events.\
Whether you're a beginner or an experienced developer, FMAOS provides a seamless experience to bring your designs to life.
...
- **Customization:** Tailor animations to suit your project's aesthetic and functional requirements. Adjust timing, duration, easing and many more effortlessly with FMAOS's intuitive configuration options.
